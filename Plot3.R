...
Plot3 <- ggplot(baltcitymary.emissions.byyear, aes(x=factor(year), y=Emissions, fill=type,label = round(Emissions,2))) +
  ...
  geom_label(aes(fill = type), colour = "black", fontface = "bold")
print(Plot3)
